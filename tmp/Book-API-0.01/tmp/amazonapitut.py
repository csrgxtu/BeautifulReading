...
amazon = AmazonAPI(AMAZON_ACCESS_KEY, AMAZON_SECRET_KEY, AMAZON_ASSOC_TAG, region="CN")
#amazon = AmazonAPI(AMAZON_ACCESS_KEY, AMAZON_SECRET_KEY, AMAZON_ASSOC_TAG)
#product = amazon_cn.lookup(ItemId='9787540472238')
product = amazon.lookup(IdType='ISBN', ItemId='9787540472238', SearchIndex='Books')
